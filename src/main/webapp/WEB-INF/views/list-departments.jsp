...
<html>
<head>
    <title>University Management - Departments</title>
    <style>
        :root {
            --primary: #2357F4;
            --dark: #4A72D1;
...
<div class="container">
    ...
    <div style="margin-bottom: 20px;">
        <a href="${pageContext.request.contextPath}/departments/showFormForAdd" style="padding: 10px 15px; background-color: var(--success); color: white; text-decoration: none; border-radius: 4px;">Add Department</a>
    </div>
            ...
            <c:forEach var="department" items="${departments}">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="${deleteLink}" style="color: var(--danger);" onclick="if (!(confirm('Are you sure you want to delete this department?'))) return false">Delete</a>
                    </td>
                </tr>
            </c:forEach>
